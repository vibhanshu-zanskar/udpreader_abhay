...
namespace znsreader
{
PacketReader::PacketReader(const std::string &address, uint16_t port) : m_address(address), m_port(port)
{
...
ssize_t
PacketReader::receivePackets(unsigned char *buf, size_t bufLen)
{
